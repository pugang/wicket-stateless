...
public class Parameters<T> {
	 ...
	 * 
	 * @param params
	 *          values will be taken from these PageParameters
	 * @param beanToPopulate
	...
	/**
	 * Check is the {@link StringValue} is not empty and pasrable integer
	 * 
	 * @param number
	 *          Parameter value
	 * @return true if {@link StringValue} is an int
	 */
	public static boolean isInteger(StringValue number) {
